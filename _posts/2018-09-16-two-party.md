...
Polarized, discreet, binary self-imagery and self-understanding self-inflict willful blindness of the messy middle where most of us, and most projects, spend most of the time.  Any simple theory, or simple history, of software production, or of open source, is always too simple.  Any forceful effort to _make_ them simple inflicts collateral damage.
