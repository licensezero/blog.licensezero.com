...
1. Vocal open source activists perceive more threat from approaches close to open source orthodoxy than from closed and proprietary software.  Make proprietary software with open source, the community will honor your choice.  Offer open source terms, but not to everyone, or offer slightly less permission, and the pious will flood your social media with scorn.
2. Incorrect legal statements, flawed legal reasoning, and the imputed legal soundness of foundation-blessed policy positions create fear, uncertainty, and doubt in developers without lawyers of their own.  Bombardment by misinformation and uncertainty leaves a false impression often the inverse of law and policy in actual effect.

Both Commons Clause and Lerna could have done better to minimize needless drama and confusion.  But anyone trying something new in the community should anticipate heat.  As an attorney, legal misinformation and empty legal threats worry me most.  But the more pressing issue, for anyone attempting to solve urgent problems with the distributed, individual power of licensing terms, is the insistence on a kind of dead, innovation-free zone around open source practice.
...
On that line, we could further subdivide open source software into _permissive software_ under terms like MIT, BSD, and Apache, and _copyleft software_ under terms like GPL and EPL.  How those subtypes relate on the spectrum depends on your politics.  

Software Freedom advocates describe copyleft software as not just "open", like permissive software, but "locked open", in that it can't be put into proprietary software, at least in particular ways.  In their view, that makes copyleft software more open than permissive software:
...
Conversely, permissive-license advocates, often associated with the BSD school, see the share-alike conditions of copyleft licenses as restrictions on what can be done with the software.  Since permissive software is less restricted than copyleft software, that makes permissive software more open:
...
The one-dimensional view of open source expresses this, the classic debate _within_ free and open source software of the last twenty years.  But like a cartoon, this one-dimensional view oversimplifies reality and open practices fit within it.  We can reach its limit by asking where to plot _source-available software_: software for which source code is available, but without any permissive or copyleft license.
...
It isn't enough to use distribution terms, or license, that meets the criteria of the Definition.  The license has to apply to source code that's available.

The choice of the term "open source", and attempts to trademark it, run into trouble precisely because "open source" has natural meaning in just one dimension, but tries to cover two.  "Open source software" is plain, common English for software with source that is open, as in available.  "Open" doesn't naturally say anything about permission to modify, distribute, and so on, though that's just as essential.
...
I began by noting that the reactions to Commons Clause and the Lerna exclusion show that vocal members of the greater community seem to be more comfortable with proprietary software, with closed source and no rights granted, than with source-available approaches.  In other words, when a project takes a position _between_ proprietary software and orthodox open source software, on either underlying dimension, the project tends to hear either that it should close its source code, or that it should revert to a standard open source license.  Never that it should experiment in new territory.
...
Both in terms of where free and open source software gets done, especially its Internet infrastructure, and in terms of license conditions, open source advocates aren't satisfied to guard the border walls of their movements, be they definitions, stated principles, or shared norms.  On spotting any credible or even feeble threat within sight of their walls, some open source advocates draw down the gate and charge on horseback to meet it and either chase it away or stab it dead.

When pressed, defenders of the open source realm tend to express very directly that these innovations pose threats to the community, even if the walls remain strong.  More specifically, their concerns often sound in _confusion_ or _efficiency_.

On the infrastructure side, confusion manifests as worry that users who come to open source will have their expectations frustrated, or fall prey to bait-and-switch.  Among the properly open source code they find through a repository, source code host, or search platform, they may unwittingly find code they don't have permission to use in their particular way, for their particular client, or for their particular purpose.  Infrastructure-based efficiency concerns lament that even users who become aware of these pitfalls will have to spend substantial time assessing what they find, to make sure it is what they hope it is.
...
As with many border zones drawn abstractly, as by maps or territorial definitions, the trouble is what's already there, and the natural and social forces that abhor abstract barriers.  The buffer zones that some members of the community adamantly defend might do well for open source, were they respected.  But as one part of the community repulses all encroachments on one front, other parts of the community embrace open borders at the rear.

A preponderance of vital and popular open source infrastructure services of the current generation, from GitHub to npm to Travis CI, _require_ open source in only one dimension: availability.  If you're willing to publish your code, the service stands open to your project, often free of charge.  If you want to use the same services and tools to work privately, you pay for the privilege.

As for what license terms apply to the work you share, the services take the minimal license they need to provide their functionality, through terms of service.  They don't rely on you to pick a license that gives them the permission they need.  They don't police what terms to offer to others, and happily count even totally unlicensed code, and users who publish only unlicensed code, toward their user counts.

With the partial exception of Stack Overflow, which poses its own unique problems, the most popular sources of open source today don't make any guarantees about licensing.  It's up to users to search, filter, and audit what they find.  The platforms do provide functionality related to licensing, but only functionality to make licensing information more visible, and to facilitate independent auditing, as with software tools that process standardized licensing metadata.  In other words, tools for coping with diversity, rather than curtailing it.