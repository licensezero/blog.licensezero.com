...
Abstracting people along those lines needn't shock the conscience.  But we know how it so often does.  Abhorrent working conditions.  Subsistence pay.  Tax relief starving public infrastructure.  It's impossible to tell, holding a finished product, whether someone involved in the making lived out the consequences of a race to the bottom, under hands that passed down far less than a rightful share of what they received.  The system works well when, and only when, fair compensation goes down as the work comes up, at each stage.

In theory, we expect negotiation to calibrate all aspects of working life, from pay to working hours, up and down the chain.  In practice, competition often leads those on higher rungs to where there's no functioning market below, no alternatives, and therefore not much of a negotiation.  The moral response is corporate social responsibility, sending not just quality controllers to police corner-cutting and substitution, but auditors to uphold work standards.  And selective purchasing, as a consumer, from responsible companies.

Open source developers put themselves down toward the bottom of the software supply line.  In open source, we increasingly abstract people down the supply chain just as effectively as in hard-goods commerce.  There are two key differences.  We don't pay people we abstract away in open source.  The race to the bottom on price can't go any lower, as long as producers don't start paying consumers as a loss-leader.  But it's also far easier to reverse the abstraction of contributors.  Finding out who sewed my sneakers would probably involve international travel.  But I can usually find out who wrote my hyphenation library with a few shell commands, or at worst by request to an online repository that will tell me, immediately and for free.
