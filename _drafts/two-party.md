...
Before GitHub, open source, and free software, before even hacks and hackers and hacking as we know them, there has always been a movement demanding something back from the industry.  Hackers and hobbyists wanted community.  Academics wanted collaboration.  Craftsmen wanted reputation.  Free software wanted purpose.  Open source, having inherited community, collaboration, reputation, and purpose, wanted to keep those things, but also acceptance back into industry.  And got it.

Having met its own definition of success, open source can no longer call itself a counterculture.  Self-styled opposites---closed, proprietary software on the one hand, open, permissive software on the other---now thrive in self-declared symbiosis, at least for those who came to accord from prior positions of strength.
...
React, Redis, Lerna.  Three license tiffs in less than one year.  Each reaffirming a troubling trend in open source politics: eroding respect for developers' rights to choose their terms.  Eroding respect for the very lever the law gives creative individuals to demand something back from larger interests.

Grabbing license power out of developers' hands sets the community police on a conflict course with those solving large and practical community problems.  Practical problems that include financial inequity and the decay of copyleft.  Solutions that include License Zero.

I'll be frank.  Facebook's `PATENTS` file, Commons Clause, and Lerna-style blacklists don't matter that much, in the grand scheme.  They're niche tools, and few others will need to use them.  But you wouldn't know that from the reactions.

The purported existential threat to open source from these experiments can have little to do with their non-popularity and narrow utility.  It has everything to do with the power to experiment, and the power with which they experimented.  For some, the very prospect of license innovation threatens open source as they know it.  That being the case, it isn't enough to defend a definition, proclaim whether new iterations meet it, and avoid those that don't.  If a new approach falls outside, and especially if it falls _just_ outside, the line, a preemptive sortie must head out to rebuke, rout, and if at all possible eliminate it from the field of available developer choice.  Even if that means telling an open project to "just go proprietary" and close their source.

As I've followed responses to React, the Redis modules, and Lerna, I've been most disturbed by the use of legal fear, uncertainty, and doubt to cow developers experimenting with their rights.  As a lawyer, that kind of leverage offends me, morally.  I have to call it out, and I'm not done writing about it.  But in the end, appeal to fear of law is just a tactic, incidental to a broader program.

The broader program leads to a disciplined, two-party system in software that constrains developer choice to market-optimized "proprietary", at one extreme, or community-policed "open", at the other, and no great choices for those in the middle.  Within that system, third parties, especially third parties near to one or the other major party, threaten to split attention, loyalty, and credit off the incumbents.  At a higher level, alternatives threaten the ability of the bipartite system to claim effective representation of the whole community, despite failing to address pervasive problems.

Projects that make source available, but effectively hold back some permission, as for commercial, closed-source, or unethical use, prove that you don't have to adopt the whole sanctioned open source creed, or all at once, to share and build code publicly online.  Publishing code alone brings many of the benefits currently imputed exclusively to open source under licenses blessed before there was GitHub.  Moreover, live experiments reinforce that developers needn't rely on any outside institution's help or approval to prepare or approve terms for use.  The political-system metaphor falls short, because developers don't need anyone to represent them in this.  Licensing gives contributors individual power, and how they use it is their individual choice.  The community can develop, identifying, compare, and assimilate new licensing approaches, much as it nurtures and elevates new software.

In the end, license experiments _are_ a threat, but no a threat to open source, even as defined.  Patches to existing licenses and license ideas don't change how effective unpatched terms remain for other work.  Rather, innovation threatens the symbiosis of open source orthodoxy and enterprise-procurement-bound proprietary consumers.  Holding permission back reduces what the shepherds of open source can lead back to large companies.  Offering a compelling middle way that better balances concerns for smaller players reduces the number of projects that end up under pushover licenses for lack of a nearer-fitting option, and therefore susceptible to selective assimilation by incumbents that would outlast or outcompete than sustain or compensate.  Suppressing license choices in the middle also suppresses species of contributors best served by those choices.

# Spectrum

Enforcing diametric software choice is rarely an explicit personal or institutional program.  It doesn't have to be.  The very way free and open source software advocates learned to talk about free and open source software---mostly amongst themselves, before industry was interested---baked the dichotomy into the common view of the software world, just as polarized and polarizing left-right vocabulary limits our politics.  Third ways defy that vocabulary, and threaten the corresponding mindset.  To have a better conversation, we need a better vocabulary, and a way to get there from how we think and talk now.
...
In the early days, before open source and industry came together to make the line horseshoe-shaped, parallels to the left-right political spectrum were often explicit:
...
Software freedom advocates describe copyleft software as not only open, like permissive software, but locked open, unable to be closed.  In their view, these additional license rules make copyleft the more open:
