...
Nadia Eghbal's [Roads and Bridges: The Unseen Labor Behind Our Digital Infrastructure](https://www.fordfoundation.org/library/reports-and-studies/roads-and-bridges-the-unseen-labor-behind-our-digital-infrastructure/) called renewed attention to the open source sustainability problem, finally usurping the dominant, stale vocabulary of imagery and theory we use to talk about that problem.  As always, Nadia chose her words, including her title, very capably.  "Infrastructure" is a noble and pleasingly utilitarian way to see open source software, more productive than the counterculture or ecosystem metaphors still in vogue at the time.  The problems with that infrastructure hurt for the fact we usually don't even see it, much the less the people making and maintaining it.

In the past few years, independent efforts around open source licensing, packaging, and compliance coalesced into a complete maintainer-to-user toolchain that lets open source consumers eat their fill without ever so much as glancing the names of the developers behind the work.  I've contributed a small bit to that system, convincing thousands of open source maintainers to disappear themselves from the consciousness of their programming peers.
...
There is a view of open source licensing, often associated with the modern BSDs, that defines developer freedom not just as maximum permission, but maximum convenience, as well.  That school naturally privileges permissive licenses over copyleft licenses, and short licenses over longer ones.  It maxes out with [public domain dedications](https://creativecommons.org/publicdomain/zero/1.0/) and [abrasive anti-licenses](https://www.wtfpl.net), then retreats to the likes of [The Unlicense](https://www.unlicense.org) and [The Free Public License](https://opensource.org/licenses/FPL-1.0.0), and finally to the practicality of the old classics, the MIT and the two-clause BSD licenses.  From this point of view, even attribution---copying copyright notices and license terms---should be eschewed, if only legal circumstances uniformly permitted.

The licensing-compliance toolchain crosses most of the last mile from legal practicality to maximum convenience and minimum bother.  With the right tooling and the right data, the choice, use, and redistribution of open source software becomes an automated affair.
