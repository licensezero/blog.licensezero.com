...
Every approaching to meeting users' needs over time is a software-production model, but not every software-production model is a business model.  If you implement, distribute, and give permission away, completely and before payment, full stop, you do not have a business model.  You need to fulfill at least one need, more completely than you have before, for more users than you have before, _after payment_, and not before.  Any model meeting that criterion is a complete business model.  Any business model meeting the additional criterion of creating only open source is a complete open source business model.

You can have a business without a complete open source business model, but you will need some other complete business model to have a business.  Perhaps one of the plans Raymond described.  If the only business you manage is your own, perhaps another form of payoff, like educational value, reputation, or simple enjoyment.  But giving software away, on its own, is the antithesis of a plan for getting paid.  If you receive compensation for such generosity, either you weren't actually being generous, your "customer" was the one being generous, or one of you has made a big mistake.

# Exploration

With all of this in mind, we can begin to chart complete, pure open source business models, both known-viable and innovative.

Archetypical permission-based business plans like dual licensing and delayed release typically focus on permission alone.  They implement all the code needed to make their projects worth licensing, and distribute all of that code under an open source license, prior to any payment.

Note that traditional dual licensing and delayed release entail speculation.  Businesses practicing those models implement, or buy an implementation to license, before payment.  The businesses invest the cost of implementation in expectation of license fees they hope customers will pay later.  The higher the cost implementation---the more labor-intensive the project, the more expensive the inputs like outside help, data, and development tools, the more the business chooses to implement up-front---the greater the speculative bet.  Large enough bets frequently require enlisting outside speculators, be they investors, lenders, or contributors willing to work for deferred or equity compensation.
